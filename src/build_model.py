...
def build_asr_model(args):
    ...
    if hasattr(args, "decoder") and args.decoder is not None:
        if args.decoder=="MySanmDecoder":
            ...
            refiner=BertModel.from_pretrained(args.span_conf["refiner_path"])
            if args.dataset_name=="AISHELL-NER":
                name_entity_num=3
                action_num=0
                scenario_num=0
                span_task="ner"
            elif args.dataset_name=="SLURP":
                name_entity_num=56
                action_num=54
                scenario_num=18
                span_task="ner+ic"
            ...
            decoder=MySanmDecoder.ParaformerSANMDecoder(
                ...
                inner_dim=args.span_conf["inner_dim"],
                name_entity_num=name_entity_num,
    ...
    if args.model in ["asr", "mfcca"]:
        ...
        model = MyParaformer.Paraformer(
            ...
            token_list=token_list,
            predictor=predictor,
            span_alpha=args.span_conf["span_alpha"],
            name_entity_num=name_entity_num,
            action_num=action_num,
            scenario_num=scenario_num,
            **args.model_conf,
